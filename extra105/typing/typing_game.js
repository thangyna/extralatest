            ...
            fetch('../assets/keyboards/' + keyboardLayout + '.html')
                ...
                .then(html => {
                    ...
                    function showModal(score, correctChars, mistakes, accuracy, typingSpeed, topMistakes, isDisplay) {
                        ...
                        document.getElementById('resultScore').innerText = "スコア: " + score.toLocaleString();
                            ...
                            .then(data => {
                                ...
                                // ランキングがある場合
                                    ...
                                    data.ranking.forEach((item, index) => {
                                        ...
                                        listItem.textContent = `${item.username}: ${item.score.toLocaleString()}`;
                    ...
                    /*------------------------------------------------
                        キー、ボタン入力の処理
                    ------------------------------------------------*/
                    function convertKeyCode(_keyCode) {
                        if (!isConvert)
                            return _keyCode;
                    ...
                    document.addEventListener("keydown", function (event) {
                        ...
                        // プレイ中の場合
                            ...
                            processInput(convertKeyCode(key));
                        }
                    });
