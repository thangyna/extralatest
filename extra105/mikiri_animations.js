...
function scrollBackground() {
    ...
    elem2.style.backgroundPosition = posX/2 + "px 0px";
    elem3.style.backgroundPosition = posX/3 + "px 0px";
    elem4.style.backgroundPosition = posX/4 + "px 0px";
    sky.style.backgroundPosition = posX/5 + "px 0px";
